...
- The data gets stored in a Postgres Database with this Structure(Diagram made with https://app.diagrams.net/).
...
But we don't download them to store them locally. We don't need to.

You can just paste an ISBN(10) and the image will appear. That's the reason why we only use ISBN(10) and not ISBN(13).
